...
class RecoveryAgent:
    ...
    def _build_context(self, payment: dict, customer: dict) -> dict:
        ...
        context.setdefault("hour_of_day", datetime.utcnow().hour)
        context.setdefault("day_of_week", datetime.utcnow().weekday())
        context.setdefault("is_weekend", int(datetime.utcnow().weekday() >= 5))
